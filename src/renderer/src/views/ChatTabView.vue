  ...
  <div class="w-full h-full flex-row flex">
    <div
      :class="[
        ...
        artifactStore.isOpen && route.name === 'chat'
          ? 'mr-[calc(60%_-_104px)]'
          : '',
      ]"
    >
...
const ThreadsView = defineAsyncComponent(
  () => import('@/components/ThreadsView.vue'),
);
const TitleView = defineAsyncComponent(
  () => import('@/components/TitleView.vue'),
);
const ChatView = defineAsyncComponent(
  () => import('@/components/ChatView.vue'),
);
const NewThread = defineAsyncComponent(
  () => import('@/components/NewThread.vue'),
);
