...
const serverResources = computed(() => {
  if (props.serverName) {
    return mcpStore.resources.filter(
      (resource) => resource.client.name === props.serverName,
    )
  }
    ...
    >
      <SheetHeader class="px-4 py-3 border-b bg-card flex-shrink-0">
        <SheetTitle class="flex items-center space-x-2">
          ...
          <span>{{
            props.serverName ? `${props.serverName} Resources` : 'MCP Resources'
          }}</span>
        </SheetTitle>
        <SheetDescription>
              ...
              <ScrollArea class="flex-1 min-h-0">
                <div class="px-4 py-4 space-y-4 pb-8">
                  ...
                  <div>
                    ...
                    <div class="flex items-center mt-2 space-x-2">
                      <Badge variant="outline">{{
                        selectedResourceObj.client.name
                      }}</Badge>
                  ...
                  <div class="space-y-2">
                    ...
                    >
                      <code
                        class="text-xs font-mono text-foreground break-all"
                        >{{ selectedResourceObj.uri }}</code
                      >
                    </div>
                  </div>
                  ...
                  <div>
                    <Button
                      ...
                      @click="
                        loadResourceContent(
                          selectedResourceObj as ResourceListEntry,
                        )
                      "
                    >
                      <Icon
