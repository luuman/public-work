    ...
    <Dialog v-model:open="isRagflowConfigDialogOpen">
      <DialogContent>
        ...
        <DialogFooter>
          ...
          <Button
            type="button"
            :disabled="!isEditingRagflowConfigValid"
