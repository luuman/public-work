        ...
        <div class="grid gap-4 py-4">
          <div class="grid grid-cols-4 items-center gap-4">
            ...
            <Input
              ...
              class="col-span-3"
              :placeholder="
                t('settings.provider.dialog.addCustomProvider.namePlaceholder')
              "
              required
            />
          </div>
            ...
            <Select v-model="formData.apiType" required>
              <SelectTrigger class="col-span-3">
                <SelectValue
                  :placeholder="
                    t(
                      'settings.provider.dialog.addCustomProvider.apiTypePlaceholder',
                    )
                  "
                />
              </SelectTrigger>
          ...
          <div class="grid grid-cols-4 items-center gap-4">
            ...
            <Input
              ...
              :placeholder="
                t(
                  'settings.provider.dialog.addCustomProvider.apiKeyPlaceholder',
                )
              "
              required
            />
          ...
          <div class="grid grid-cols-4 items-center gap-4">
            ...
            <span class="col-span-3 flex flex-col">
              <Input
                ...
                :placeholder="
                  t(
                    'settings.provider.dialog.addCustomProvider.baseUrlPlaceholder',
                  )
                "
                required
              />
