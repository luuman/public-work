  ...
  <ScrollArea class="w-full h-full p-2">
    <div class="w-full h-full flex flex-col gap-1.5">
      ...
      >
        ...
        <span class="text-sm font-medium"
          >{{ t('settings.data.lastSyncTime') }}:</span
        >
      ...
      <div
        ...
        :class="{
          'opacity-50 cursor-not-allowed':
            !syncStore.syncEnabled || syncStore.isBackingUp,
        }"
        :dir="languageStore.dir"
              ...
              >
                ...
                <div class="flex flex-col">
                  <Label
                    ...
                    >{{ t('settings.data.resetKnowledgeData') }}</Label
                  >
                  <p class="text-xs text-muted-foreground">
              ...
              >
                ...
                <div class="flex flex-col">
                  <Label
                    for="reset-config"
                    class="font-medium cursor-pointer"
                    >{{ t('settings.data.resetConfig') }}</Label
                  >
                  <p class="text-xs text-muted-foreground">
            ...
            <AlertDialogDescription>
              {{
                syncStore.importResult?.message
                  ? t(syncStore.importResult.message)
                  : ''
              }}
            </AlertDialogDescription>
          </AlertDialogHeader>
