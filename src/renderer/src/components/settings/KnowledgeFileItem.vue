    ...
    <div class="ml-auto flex align-center">
      ...
      <AlertDialog>
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle
              >{{ t('settings.knowledgeBase.reAddFile.title') }}
            </AlertDialogTitle>
          </AlertDialogHeader>
          <AlertDialogDescription>{{
            t('settings.knowledgeBase.reAddFile.content', {
              fileName: file.name,
            })
          }}</AlertDialogDescription>
          <AlertDialogFooter>
            <AlertDialogCancel>{{ t('common.cancel') }}</AlertDialogCancel>
            <AlertDialogAction @click="reAddFile">{{
              t('common.confirm')
            }}</AlertDialogAction>
          </AlertDialogFooter>
        </AlertDialogContent>
      ...
      <AlertDialog>
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle
              >{{ t('settings.knowledgeBase.deleteFile.title') }}
            </AlertDialogTitle>
          </AlertDialogHeader>
          <AlertDialogDescription>{{
            t('settings.knowledgeBase.deleteFile.content', {
              fileName: file.name,
            })
          }}</AlertDialogDescription>
          <AlertDialogFooter>
            <AlertDialogCancel>{{ t('common.cancel') }}</AlertDialogCancel>
            <AlertDialogAction @click="deleteFile">{{
              t('common.confirm')
            }}</AlertDialogAction>
          </AlertDialogFooter>
        </AlertDialogContent>
...
const uploadTime = computed(() => {
  return dayjs(props.file.uploadedAt)
    .tz(userTimeZone)
