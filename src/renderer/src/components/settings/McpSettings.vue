          ...
          <div class="space-y-3">
            ...
            <div class="flex items-center justify-between text-xs">
              ...
              <div class="flex items-center gap-2">
                ...
                <Badge
                  v-if="npmRegistryStatus.isFromCache"
                  variant="secondary"
                  class="text-xs"
                >
            ...
            >
              ...
              >
              <span>{{
                formatLastChecked(npmRegistryStatus.lastChecked)
              }}</span>
            </div>
                    ...
                    <div class="space-y-2">
                      ...
                      <div class="space-y-2">
                        <Input
                          ...
                          :placeholder="
                            t(
                              'settings.mcp.npmRegistry.customSourcePlaceholder',
                            )
                          "
                          class="font-mono"
                        />
...
const validateCustomRegistry = async (registry: string): Promise<boolean> => {
  try {
    ...
    toast({
      ...
      description: t('settings.mcp.npmRegistry.testingDesc', {
