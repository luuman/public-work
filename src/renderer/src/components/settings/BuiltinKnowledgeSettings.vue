            ...
            >
                ...
                <AlertDialog>
                  ...
                  <AlertDialogContent>
                    <AlertDialogHeader>
                      <AlertDialogTitle>{{
                        t(
                          'settings.knowledgeBase.removeBuiltinKnowledgeConfirmTitle',
                          {
                      ...
                      <AlertDialogDescription>
                        {{
                          t(
                            'settings.knowledgeBase.removeBuiltinKnowledgeConfirmDesc',
                          )
                        }}
                      </AlertDialogDescription>
                    </AlertDialogHeader>
              ...
              <div class="grid gap-2">
                ...
                >
                  <div>
                    <b class="font-medium">
                      {{ t('settings.knowledgeBase.embeddingModel') }}:</b
                    >
                    <span> {{ config.embedding.modelId }} </span>
                  </div>
                  <span v-if="config.rerank && config.rerank.modelId">
                    <b class="font-medium"
                      >{{ t('settings.knowledgeBase.rerankModel') }}:</b
                    >
            ...
            <div class="space-y-4 py-4">
              <div class="space-y-2">
                ...
                <Input
                  ...
                  required
                  :placeholder="
                    t('settings.knowledgeBase.descriptionPlaceholder')
                  "
                />
              </div>
              <div class="space-y-2">
                    ...
                    <Tooltip :delay-duration="200">
                      ...
                      <TooltipContent>
                        <p>
                          {{
                            t(
                              'settings.knowledgeBase.selectEmbeddingModelHelper',
                            )
                          }}
                        </p>
                      </TooltipContent>
              ...
              <div class="space-y-2" v-if="!autoDetectDimensionsSwitch">
                    ...
                    <TooltipProvider>
                      <Tooltip :delay-duration="200">
                        ...
                        <TooltipContent>
                          <p>
                            ⚠️
                            {{ t('settings.knowledgeBase.dimensionsHelper') }}
                          </p>
                        </TooltipContent>
                      </Tooltip>
                    </TooltipProvider>
                ...
                <Input
                  ...
                  :placeholder="
                    t('settings.knowledgeBase.dimensionsPlaceholder')
                  "
                  :disabled="isEditing"
                ></Input>
              </div>
                  ...
                  <div class="flex items-center gap-1">
                    ...
                    <TooltipProvider>
                      <Tooltip :delay-duration="200">
                        ...
                        <TooltipContent>
                          <p>
                            {{ t('settings.knowledgeBase.normalizedHelper') }}
                          </p>
                        </TooltipContent>
                      </Tooltip>
                    </TooltipProvider>
                  ...
                  <AccordionContent class="space-y-4">
                    <div class="space-y-2">
                      ...
                      <Input
                        ...
                        :Placeholder="
                          t('settings.knowledgeBase.chunkSizePlaceholder')
                        "
                        :step="128"
                      ></Input>
                    </div>
                    <div class="space-y-2">
                      ...
                      <Input
                        ...
                        :placeholder="
                          t('settings.knowledgeBase.chunkOverlapPlaceholder')
                        "
                        :step="128"
                      ></Input>
                    </div>
                            ...
                            <Tooltip :delay-duration="200">
                              ...
                              <TooltipContent>
                                <p class="w-64">
                                  {{
                                    t(
                                      'settings.knowledgeBase.fragmentsNumberHelper',
                                    )
                                  }}
                                </p>
                              </TooltipContent>
...
const editBuiltinConfig = async (index: number) => {
  ...
  autoDetectDimensionsSwitch.value =
    editingBuiltinConfig.value.dimensions === undefined
  submitLoading.value = false
  isBuiltinConfigDialogOpen.value = true
}
...
const saveBuiltinConfig = async () => {
  ...
  if (isEditing.value) {
    ...
    if (editingConfigIndex.value !== -1) {
      builtinConfigs.value[editingConfigIndex.value] = {
        ...editingBuiltinConfig.value,
      }
    }
    toast({
