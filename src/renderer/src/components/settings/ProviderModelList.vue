  ...
  <div class="flex flex-col w-full gap-2">
    ...
    >
      ...
      <Input
        ...
        :placeholder="t('model.add.idPlaceholder')"
      />
      <Input
      ...
      <Select v-model="model.type" class="w-16">
        ...
        <SelectContent>
          <SelectItem
            v-for="type in Object.values(ModelType)"
            :key="type"
            :value="type"
          >
            {{ type }}
    ...
    <div class="text-xs text-muted-foreground px-2">
      {{ t('model.type.official') }}
    </div>
    <div
      v-for="provider in filteredProviderModels"
    ...
    >
      ...
      >
        <ModelConfigItem
          ...
          :type="model.type ?? ModelType.Chat"
          @enabled-change="
            (enabled) => handleModelEnabledChange(model, enabled)
          "
          @config-changed="$emit('config-changed')"
        />
      </div>
...
const handleModelEnabledChange = (
