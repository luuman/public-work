  ...
  <div class="my-1">
    ...
    >
      <div class="flex flex-row items-center gap-2 w-full">
        ...
        <div
          class="flex-shrink-0 pr-2 rounded-lg rounded-l-none flex justify-center items-center"
        >
          <Icon
            :icon="getStatusIcon()"
            :class="['w-4 h-4', getStatusIconClass()]"
          />
        </div>
      </div>
      <div class="h-0"></div>
    ...
    >
      ...
      <div class="flex items-center gap-2 mb-2">
        ...
        <Icon
          ...
          :class="['w-3 h-3', getPermissionIconClass()]"
        />
