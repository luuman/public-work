...
const SearchConversationsArgsSchema = z.object({
  query: z
    .string()
    .describe(
      'Search keyword to search in conversation titles and message contents',
    ),
  limit: z
    .number()
    .optional()
    .default(10)
    .describe('Result limit (1-50, default 10)'),
  offset: z
    .number()
    .optional()
    .default(0)
...
const SearchMessagesArgsSchema = z.object({
  ...
  conversationId: z
    ...
    .optional()
    .describe(
      'Optional conversation ID to limit search within specific conversation',
    ),
  role: z
  ...
  limit: z
    ...
    .optional()
    .default(20)
    .describe('Result limit (1-100, default 20)'),
  offset: z
    .number()
    .optional()
    .default(0)
...
const CreateNewTabArgsSchema = z.object({
  ...
  position: z
    .number()
    .optional()
    .describe('Optional position for the new tab in the tab bar.'),
  userInput: z
    .string()
    .optional()
      ...
      try {
        switch (name) {
          ...
          case 'create_new_tab': {
            ...
            const newTabId = await presenter.tabPresenter.createTab(
              mainWindowId,
              url,
              {
                active,
            ...
            const newThreadId =
              await presenter.threadPresenter.createConversation(
                'New Chat', // 临时标题
                {}, // 默认设置
                newTabId,
              );
