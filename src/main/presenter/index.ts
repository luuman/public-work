...
export class Presenter implements IPresenter {
  ...
  constructor() {
    ...
    // this.devicePresenter.cacheImage()
    // this.devicePresenter.resetDataWithConfirm()
    // this.devicePresenter.restartAppWithDelay()
    // this.devicePresenter.selectDirectory()
    ...
    // appLog.info('Presenter initialized', this.logPresenter)
  ...
  //     appLog.info('FloatingButtonPresenter initialized successfully')
  //   } catch (error) {
  //     appLog.error('❌Failed to initialize FloatingButtonPresenter:', error)
  //   }
  // }
  ...
  //       appLog.info('syncCustomModels', provider.id, customModels)
